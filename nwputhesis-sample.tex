%%
%% This is file `nwputhesis-sample.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% nwputhesis.dtx  (with options: `sample')
...
%% 常用选项：degree=master|phd, academic=true|false, blindreview=true|false
 \documentclass[lang=chs, degree=master, blindreview=false, adobe=false, academic=true]{nwputhesis}
...
\author{\blindreview{航小天}}{\blindreview{Xiaotian Hang}}  % 姓名（添加盲评标记）
...
\advisor{\blindreview{航大天}}{\blindreview{Datian Hang}}      % 导师（添加盲评标记）
