...
如\autoref{alg:undergraduate-binary-search}所示，二分查找每一步都将搜索区间缩小为原来的一半，
因此具有较高的检索效率。

\begin{algorithm}[htbp]
    \caption{二分查找算法示例}
    \label{alg:undergraduate-binary-search}
    \begin{algorithmic}[1]
...
对于长度为 $n$ 的有序数组，\autoref{alg:undergraduate-binary-search} 在最坏情况下需要进行
